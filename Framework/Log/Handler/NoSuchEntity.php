 ...
 */
final class NoSuchEntity extends \Justuno\Core\Framework\Log\Handler {
	/**
	 * 2021-09-08
	 * @override
	 ...
	 */
	protected function _p():bool {return ($e = $this->r()->e()) instanceof NSE && ju_bt_has(Session::class, 'getQuote', $e);}
}