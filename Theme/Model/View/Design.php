<?php
namespace Justuno\Core\Theme\Model\View;
use Magento\Theme\Model\View\Design as mDesign;
/**
 * 2017-10-17
 * 2020-08-23 "Port the `Df\Theme\Model\View\Design` class" https://github.com/justuno-com/core/issues/302
...
class Design extends mDesign {
	...
	final static function isThemeInitialized():bool {
		$d = ju_o(mDesign::class); /** @var mDesign $d */
		return !!$d->_theme;
	}
}