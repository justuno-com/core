<?php
namespace Justuno\Core\Cron\Model;
...
class LoggerHandler extends _P {
	 ...
	 * 2019-10-13
	 * 2021-12-21
	 * 1) "«Declaration of Justuno\Core\Cron\Model\LoggerHandler::handle(array $d)
	 ...
	 * 2) @see \Justuno\Core\Framework\Log\Dispatcher::handle()
	 * @override
	...
	final static function p(array $d):bool {
		...
		return
			...
			|| ju_starts_with($m, 'Add of item with id') && ju_ends_with($m, 'was processed')
			/**
			 * 2020-05-07
			 ...
			 */
			|| ju_starts_with($m, 'Remove on item with id') && ju_ends_with($m, 'was processed')
			# 2020-02-16
			# "Prevent Magento from logging «Item ... was updated» records to `system.log`":
			# https://github.com/tradefurniturecompany/site/issues/46
			|| ju_starts_with($m, 'Item') && (ju_ends_with($m, ['was removed', 'was updated']))
			/**
			 * 2019-12-24
			 ...
			 */
			|| ju_ends_with($m, 'cron jobs were cleaned')
			|| ju_starts_with($m, 'Cron Job ') && (
				/**
				 * 2019-12-24
				 * "Prevent Magento from logging successful cron events":
				 * https://github.com/royalwholesalecandy/core/issues/57
				 ...
				 */
				|| ju_contains($m, ' is successfully finished. Statistics: ')
				/**
				 * 2019-12-24
				 * "Prevent Magento from logging successful cron events":
				 * https://github.com/royalwholesalecandy/core/issues/57
				 ...
				 */
				|| ju_my_local() && ju_contains($m, ' is missed at ')
			)
			/**
			 * 2019-10-13
